...
class PowerBIContext(SetContext):
    ...
    def set_context(self):
        ...
        system_prompt=f"""
            ...
            Focus on : 
            - Generating documentation for the PowerBI report, whose report.json is attached here : \n {self.report} \n
            - Extracting meaningful data from the attached report which is useful in a wiki page.
            - Giving a comprehensive overview of the report.
            - Generating table dictionary (in the form of a formatted markdown table), table dependencies(in the form of a formatted makdown table), data flow and data explorer from the tmdl files in the SemanticModel folder of this PowerBI report, which is attached here : \n {self.semantic_model} \n
            - Making the wiki page clear and avoiding redundancy.

            """
        if self.user_context != "":
            system_prompt+=f"""
                    This is user-attached contextual information which would be very useful in accurate documentation generation.
                    Give more emphasis to the context attached and make sure you include this in the documentation.
                    Context attached : {self.user_context}
"""
        user_prompt="""
            - Generate documentation based on this power bi report.
